...
executable:
	...
	@pyinstaller --onefile -n xmrsigner-${VERSION} --add-data "${BUILD_DIR}/xmrsigner/resources:xmrsigner/resources" --collect-all xmrsigner --collect-data "xmrsigner:xmrsigner" --hidden-import PIL._tkinter_finder --collect-submodules PIL --collect-submodules PIL.ImageTk -p ${BUILD_DIR} xmrsigner
